...
const TOWNS: Record<string, string> = {
  ...
  "Esportiu Bonmatí": "Bonmatí", "Restaurant Amura": "Sant Feliu de Guíxols", "Veterans Sant Antoni": "Sant Antoni de Calonge",
  "FC Palafrugell Veterans": "Palafrugell", "Veterans Ath. Hostalric": "Hostalric", "Athlètic Can Borell": "Can Borell",
  "Veterans Sant Andreu": "Girona", "CE l'Aigüeta": "L'Aigüeta", "EF Maçanet": "Maçanet de la Selva",
